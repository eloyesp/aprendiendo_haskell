...
you!](why-functional-programming-why-haskell.html#id528893)

[Novelty](why-functional-programming-why-haskell.html#id528233)

[Power](why-functional-programming-why-haskell.html#id563635)

[Enjoyment](why-functional-programming-why-haskell.html#id529125)

[What to expect from this
book](why-functional-programming-why-haskell.html#id529185)

[A little bit about
you](why-functional-programming-why-haskell.html#id528412)

[What to expect from
Haskell](why-functional-programming-why-haskell.html#id528460)

[Compared to traditional static
languages](why-functional-programming-why-haskell.html#id528487)

[Compared to modern dynamic
languages](why-functional-programming-why-haskell.html#id572991)

[Haskell in industry and open
source](why-functional-programming-why-haskell.html#id573062)

[Compilation, debugging, and performance
analysis](why-functional-programming-why-haskell.html#id573188)

[Bundled and third party
libraries](why-functional-programming-why-haskell.html#id573275)

[A brief sketch of Haskell's
history](why-functional-programming-why-haskell.html#id573401)

[Prehistory](why-functional-programming-why-haskell.html#id573413)

[Early antiquity](why-functional-programming-why-haskell.html#id573451)

[The modern era](why-functional-programming-why-haskell.html#id573493)

[Helpful
resources](why-functional-programming-why-haskell.html#whyfp.resources)

[Reference
material](why-functional-programming-why-haskell.html#whyfp.resources.reference)

[Applications and
libraries](why-functional-programming-why-haskell.html#whyfp.resources.apps)

[The Haskell
community](why-functional-programming-why-haskell.html#whyfp.resources.community)

[Acknowledgments](why-functional-programming-why-haskell.html#id573806)

[Bryan](why-functional-programming-why-haskell.html#id573825)

[John](why-functional-programming-why-haskell.html#id573859)

[Don](why-functional-programming-why-haskell.html#id573887)

[Thank you to our
reviewers](why-functional-programming-why-haskell.html#id573920)
...
`for`{.code} loop built into the language. We have other, more flexible,
ways to perform repetitive tasks.
...
Throughout this book, we will show you how Haskell's alternatives to the
features of traditional languages are powerful, flexible, and lead to
reliable code. Haskell is positively crammed full of cutting edge ideas
about how to create great software.
...
~~~~ {#KMinima.hs:minima .programlisting}
...
news is that the fun begins early: it's simply an entertaining challenge
to dig into a new language, in which so many commonplace ideas are
different or missing, and to figure out how to write simple programs.
...
As a new Haskell programmer, you'll inevitably start out writing quite a
bit of code by hand for which you could have used a library function or
programming technique, had you just known of its existence. We've packed
this book with information to help you to come up to speed as quickly as
possible.
...
Many people are rightfully suspicious of “design by committee”, but the
work of the Haskell committee is a beautiful example of the best work a
committee can do. They produced an elegant, considered language design,
and succeeded in unifying the fractured efforts of their research
community. Of the thicket of lazy functional languages that existed in
1990, only Haskell is still actively used.

Since its publication in 1990, the Haskell language standard has seen
five revisions, most recently in 1998. A number of Haskell
...
-   For questions about language syntax and features, the [Haskell 98
    Report](http://haskell.org/onlinereport/) describes the Haskell 98
    language standard.

-   Various extensions to the language have become commonplace since the
    Haskell 98 Report was released. The [GHC Users's
...
If you're looking for a Haskell library to use for a particular task, or
an application written in Haskell, check out the following resources.
...
-   Haskellers use a number of [mailing
    ...
    `haskell-cafe`{.code}. It has a relaxed, friendly atmosphere, where
...
-   For real-time chat, the [Haskell IRC
    ...
    `#haskell`{.code}, is large and lively. Like `haskell-cafe`{.code},
    the atmosphere stays friendly and helpful in spite of the huge
...
-   The [Haskell Weekly News](http://sequence.complete.org/) is a
...
-   The [Haskell Communities and Activities
    Report](http://haskell.org/communities/) collects information about
    people that use Haskell, and what they are doing with it. It has
    been running for years, so it provides a good way to peer into
    Haskell's past.
...
[Mattahan](http://mattahan.deviantart.com/).
  ...
  -------------------- -------------------- ------------------------------
  [Prev](index.html)                        [Next](getting-started.html)
  Real World Haskell   [Home](index.html)   Chapter 1. Getting Started
  -------------------- -------------------- ------------------------------
